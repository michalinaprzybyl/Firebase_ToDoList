...
export default function () {
    ...
    onValue(todoRef, (snapshot) => { // funkcja wykonująca kod kiedy wartość z todoRef się zmieni
        const data = snapshot.val(); // wyciągam dane ze snapshota;
        console.log(data);
        if (!data) {
            // 1. Wyczyść contentContainer.
            // 2. Stwórz element <h2> z textContent "Add, remove and edit your todos" i podepnij go do contentContainer'a.
            // 3. Wywołaj funckję renderTodoForm i zapisz wynik wywołania do zmiennej.
            // 4. Podepnij todoForm do containera.
            // 5. Dodaj eventListener na todoForm (zareaguj na submit).
            // W eventListenerze:
            // 6. Wybierz wszystkie radio inputy i zapisz do zmiennej radios przy pomocy document.getElementsByName, a następnie zrób z tego array, bo getElementsByName zwraca NodeList.
            // 7. Z tych 4 radio imputów znajdź ten, który jezt zaznaczony (input.checked, .find(), wybieranie elementów w CSS w zależności od atrybutów), po znalezieniu inputu ściągnij z niego value.
            ...
            // 2. Stwórz zmienną listItems, wartością tej zmiennej będzie wywołanie metody .map() na zmiennej todos.
            // 3. W metodzie map:
            ...
            // - do diva podepnij spana, editButton i removeButton 
            // - do li podepnij diva 
            ...
            // 5. Do contentContainera podepnij h2.
            // 6. Do contentContainera podepnij todoForm.
            // 7. Do contentContainera podepnij ul.
            // 8. Na todoForm nałóż eventListener'a (ten sam co wyżej w tym pliku).
            ...
            // 1. Wybierz wszystkie edit buttony (wszystkie mają klasę "edit-button"), zwróci to HTMLCollection, a więc trzeba przerobić to na zwykły array.
            // 2. Na arrayu wywołaj forEach (el, i).
            // W środku forEach'a:
            // a) nadaj na element po którym iterujesz eventListener (click)
            // W środku tego eventListener'a:
            // a) usuń z domu element, po którym aktualnie iterujesz
            ...
            // e) do diva (pkt b) podepnij form (pkt c).
            ...
            editButtons.forEach((el, i) => {
                el.addEventListener("click", () => {
                    ...
                    // W eventListenerze:
                    // 2. Wybierz todo input z właściwego formularza (this.childNodes) i ściągnij wartość.
                    ...
                    form.addEventListener("submit", function (event) {
                        event.preventDefault();
                        // 2.
                        const todoInput = this.childNodes[0].value; // this w eventListenerze odnosi się do elementu, do którego ten addEventListener jest podpięty, czyli this będzie mi wskazywać na ten form; childNodes - wszystkie node'y dzieci z forma 
                        // 3.
                        const category = [...this.getElementsByTagName("input")]
                            .slice(1, 5)
                            .find(el => el.checked).value; // wyciągnie tylko inputy z tego forma; slice wytnie mi od 2 do ostatniego elementu i mi je zwróci;
